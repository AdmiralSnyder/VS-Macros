...
The Macro Explorer displays all macros in its Macro Directory, which is opened if you click the last blue arrow symbol. If you create a Folder soft link there (using `mklink /D`), you can link to whichever folder you want and the Macro Explorer displays the content of your folder of choice nested nicely.
